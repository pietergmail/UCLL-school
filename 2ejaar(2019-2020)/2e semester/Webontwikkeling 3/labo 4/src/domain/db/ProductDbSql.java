...
public class ProductDbSql implements ProductDb{
    ...
    public Product get(int id) {
        ...
        String sql = "select * from vanhaerencorentinweb3.product where productid = ?";
    ...
    public List<Product> getAll() {
        ...
        String sql = "SELECT * FROM vanhaerencorentinweb3.product";
        try (Connection connection = DriverManager.getConnection(url, properties);
    ...
    public void add(Product product) {
        ...
        sql ="select max(productid) as aantal from vanhaerencorentinweb3.product";
        String id = "";
        try (
        ...
        sql ="select count(productid) as aantal from vanhaerencorentinweb3.product where productid = ?";
        String aantal = "";
        try (
                Connection connection = DriverManager.getConnection(url, properties);
                PreparedStatement statement = connection.prepareStatement(sql))
        ...
        sql = "insert into vanhaerencorentinweb3.product(productid, name, description, price) values(?, ?, ?, ?)";
        try {
            Connection connection = DriverManager.getConnection(url, properties);
            PreparedStatement statement = connection.prepareStatement(sql);
            {
    ...
    public void update(Product product) {
        ...
        sql = "update vanhaerencorentinweb3.product set name = ?, description = ?, price = ? where productid = ?";
        try {
            Connection connection = DriverManager.getConnection(url, properties);
            PreparedStatement statement = connection.prepareStatement(sql);
            {
    ...
    public void delete(int id) {
        ...
        String sql = "delete from vanhaerencorentinweb3.product where productid = ?";
        try {
            Connection connection = DriverManager.getConnection(url, properties);
            PreparedStatement statement = connection.prepareStatement(sql);
            {
    ...
    public int getNumbeOfProducts() {
        String sql ="select count(productid) as aantal from vanhaerencorentinweb3.product";
        String aantal = "";
        try (
                Connection connection = DriverManager.getConnection(url, properties);
                Statement statement = connection.createStatement()){
