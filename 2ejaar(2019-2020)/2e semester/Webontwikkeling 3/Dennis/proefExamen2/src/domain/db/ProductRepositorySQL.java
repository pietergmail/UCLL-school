...
public class ProductRepositorySQL implements ProductRepository {
    ...
    private String url = "jdbc:postgresql://databanken.ucll.be:51920/2TX31?currentSchema=\"r0748117\"";
    ...
    public List<Product> getAll() {
        try (Connection connection = DriverManager.getConnection(url, properties);
            ...
            ResultSet resultSet = statement.executeQuery("SELECT * FROM r0748117.veggie");
