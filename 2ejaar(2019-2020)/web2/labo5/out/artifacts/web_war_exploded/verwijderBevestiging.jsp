    ...
    <div>
        ...
        <nav>
            <ul>
                ...
                <li><a href="Controller?command=search">Zoek een student</a></li>
                <li><a href="Controller?command=add">Voeg een student toe</a></li>
                <li><a href="Controller?command=overview">Bekijk alle studenten</a></li>
            </ul>
        </nav>
    </div>
