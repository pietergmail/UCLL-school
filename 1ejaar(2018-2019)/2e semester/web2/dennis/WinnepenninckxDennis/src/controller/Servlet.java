...
public class Servlet extends HttpServlet {
    ...
    public void processController(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    protected String brief(HttpServletRequest request, HttpServletResponse response) {
        return "nieuwsbrief.jsp";
    }
    protected String gesch(HttpServletRequest request, HttpServletResponse response) {
